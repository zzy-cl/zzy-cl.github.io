...
function indexTalk() {
    ...
    if (!document.getElementById('chatter-talk')) return
    ...
    function talk(ls) {
        ...
        let box = document.querySelector("#chatter-talk .talk-list")
        box.innerHTML = html;
    ...
    if (d) {
        ...
        fetch('https://memos.zhaozeyu.top/api/memo?creatorId=1&tag=动态&limit=10').then(res => res.json()).then(data => {
